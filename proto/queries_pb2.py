...
_QUERY_PAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='get_account_signatories', full_name='iroha.protocol.Query.Payload.get_account_signatories', index=2,
...
_QUERY_PAYLOAD.fields_by_name['get_account_signatories'].message_type = _GETSIGNATORIES
...
_QUERY_PAYLOAD.oneofs_by_name['query'].fields.append(
  _QUERY_PAYLOAD.fields_by_name['get_account_signatories'])
_QUERY_PAYLOAD.fields_by_name['get_account_signatories'].containing_oneof = _QUERY_PAYLOAD.oneofs_by_name['query']
_QUERY_PAYLOAD.oneofs_by_name['query'].fields.append(
