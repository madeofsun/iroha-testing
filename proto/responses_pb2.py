...
_BLOCKQUERYRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error_response', full_name='iroha.protocol.BlockQueryResponse.error_response', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BLOCKQUERYRESPONSE.fields_by_name['error_response'].message_type = _BLOCKERRORRESPONSE
...
_BLOCKQUERYRESPONSE.oneofs_by_name['response'].fields.append(
  _BLOCKQUERYRESPONSE.fields_by_name['error_response'])
_BLOCKQUERYRESPONSE.fields_by_name['error_response'].containing_oneof = _BLOCKQUERYRESPONSE.oneofs_by_name['response']
